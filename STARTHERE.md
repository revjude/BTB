...
- When you run Obsidian, **Open folder as vault**, and select the location where you downloaded or un-zipped the BTB files.
  ...
  ![OpenVault.png](/lexicon/views/userguide/OpenVault.png)
...
1. Use the gear icon ![SettingsGear.png](/lexicon/views/userguide/SettingsGear.png) below to open Obsidian's settings

2. Go to **Editor**

3. Make sure the **default view is Reading view**

![ReadingView.png](/lexicon/views/userguide/ReadingView.png)

4. Go to **Appearance** 

5. **Turn OFF** Inline titles

![InlineTitle.png](/lexicon/views/userguide/InlineTitle.png)

6. Scroll to the bottom and **turn on CSS Snippets** - **You MUST turn on CSS Snippets**

![CSSSnippets.png](/lexicon/views/userguide/CSSSnippets.png)
...
- search for a verse or chapter using dots as **book.chapter.verse** separators
  ...
  ![VerseSearch.png](/lexicon/views/userguide/VerseSearch.png)

- type: 'topic' + your topic of interest, to search the topical concordance
  
  ![TopicSearch.png](/lexicon/views/userguide/TopicSearch.png)
...
![OpenToRight.png](/lexicon/views/userguide/OpenToRight.png)
...
- Click the Expand button in the top toolbar on the right side
  ...
  ![ExpandRightSidebar.png](/lexicon/views/userguide/ExpandRightSidebar.png)

- Then click the outline icon and use the headings for navigating this page
  
  ![Outline.png](/lexicon/views/userguide/Outline.png)
...
![ModernTranslation.png](/lexicon/views/userguide/ModernTranslation.png)
...
![LXXView.png](/lexicon/views/userguide/LXXView.png)
...
![PericopeStructure.png](/lexicon/views/userguide/PericopeStructure.png)
