...
$\quad$ **1a)**(Qal) to go straight on, make progress
$\quad$ **1b)** (Piel)
$\quad$ $\quad$ **1b1)** to go straight on, advance
$\quad$ $\quad$ **1b2)** to lead on (causative)
$\quad$ $\quad$ **1b3)** to set right, righten
$\quad$ $\quad$ **1b4)** to pronounce happy, call blessed
$\quad$ **1c)** (Pual)
