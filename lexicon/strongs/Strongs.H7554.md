...
-  by analogy ***to expand*** (by hammering)
-  by implication, ***to overlay*** (with thin sheets of metal)

**1)** to beat, stamp, beat out, spread out, stretch
$\quad$ **1a)** (Qal)
$\quad$ $\quad$ **1a1)** to stamp, beat out
$\quad$ $\quad$ **1a2)** one who beats out (participle)
$\quad$ **1b)** (Piel) to overlay, beat out (for plating)
