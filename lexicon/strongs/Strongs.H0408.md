...
-  ***once*** (Job 24:25) as a noun, ***nothing***

**1)** not, no, nor, neither, nothing (as wish or preference)
$\quad$ **1a)** do not, let not (with a verb)
$\quad$ **1b)** let there not be (with a verb understood)
$\quad$ **1c)** not, no (with substantive)
$\quad$ **1d)** nothing (as substantive)
