...
-  by implication, ***to mix***
-  ***to fodder***

**1)** to mix, mingle, confuse, confound
$\quad$ **1a)** (Qal)
$\quad$ $\quad$ **1a1)** to mingle, confuse
$\quad$ $\quad$ **1a2)** to mix
$\quad$ $\quad$ **1a3)** to give provender, feed (animals)
$\quad$ **1b)** (Hithpoel) to mix oneself (among others)
$\quad$ **1c)** (Hiphil) to fade away
