...
$\quad$ **1a)** (Qal) to heal
$\quad$ $\quad$ **1a1)** of God
$\quad$ $\quad$ **1a2)** healer, physician (of men)
$\quad$ $\quad$ **1a3)** of hurts of nations involving restored favour (fig)
$\quad$ $\quad$ **1a4)** of individual distresses (fig)
$\quad$ **1b)** (Niphal) to be healed
$\quad$ $\quad$ **1b1)** literal (of persons)
$\quad$ $\quad$ **1b2)** of water, pottery
$\quad$ $\quad$ **1b3)** of national hurts (fig)
$\quad$ $\quad$ **1b4)** of personal distress (fig)
$\quad$ **1c)** (Piel) to heal
$\quad$ $\quad$ **1c1)** literal
