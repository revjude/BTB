...
-  hence (by way of alternative) or, also ***if***

**1)** or, rather
$\quad$ **1a)** implying that the latter choice is preferred
$\quad$ **1b)** or if, introducing an example to be seen under a particular principle
$\quad$ **1c)** (in series) either...or, whether...or
$\quad$ **1d)** if perchance
$\quad$ **1e)** except, or else
