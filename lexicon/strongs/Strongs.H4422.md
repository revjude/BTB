...
-  causatively, ***to release*** or ***rescue***
-  specifically, ***to bring forth young***, ***emit sparks***

**1)** to slip away, escape, deliver, save, be delivered
$\quad$ **1a)**(Niphal)
$\quad$ $\quad$ **1a1)** to slip away
$\quad$ $\quad$ **1a2)** to escape
$\quad$ $\quad$ **1a3)** to be delivered
$\quad$ **1b)** (Piel)
$\quad$ $\quad$ **1b1)** to lay, let slip out (of eggs)
$\quad$ $\quad$ **1b2)** to let escape
$\quad$ $\quad$ **1b3)** to deliver, save (life)
$\quad$ **1c)** (Hiphil)
$\quad$ $\quad$ **1c1)** to give birth to
$\quad$ $\quad$ **1c2)** to deliver
$\quad$ **1d)** (Hithpael)
