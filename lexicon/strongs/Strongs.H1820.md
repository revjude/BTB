...
-  hence, ***to fail*** or ***perish***
-  ***trans***. ***to destroy***

**1)** to cease, cause to cease, cut off, destroy, perish
$\quad$ **1a)** (Qal)
$\quad$ $\quad$ **1a1)** to cease
$\quad$ $\quad$ **1a2)** to cause to cease, destroy
$\quad$ **1b)** (Niphal)
$\quad$ $\quad$ **1b1)** to be cut off
$\quad$ $\quad$ **1b2)** to be undone, be cut off at sight of the theophany
