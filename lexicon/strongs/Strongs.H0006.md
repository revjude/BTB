...
$\quad$ **1a)** (Qal)
$\quad$ $\quad$ **1a1)** perish, die, be exterminated
$\quad$ $\quad$ **1a2)** perish, vanish (fig.)
$\quad$ $\quad$ **1a3)** be lost, strayed
$\quad$ **1b)** (Piel)
$\quad$ $\quad$ **1b1)** to destroy, kill, cause to perish, to give up (as lost), exterminate
$\quad$ $\quad$ **1b2)** to blot out, do away with, cause to vanish, (fig.)
$\quad$ $\quad$ **1b3)** cause to stray, lose
$\quad$ **1c)** (Hiphil)
$\quad$ $\quad$ **1c1)** to destroy, put to death
