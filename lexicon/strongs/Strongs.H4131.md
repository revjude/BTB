...
- ***to waver***
-  by implication, ***to slip***, ***shake***, ***fall***

**1)** to totter, shake, slip
$\quad$ **1a)** (Qal) to totter, shake, slip
$\quad$ **1b)** (Niphal) to be shaken, be moved, be overthrown
$\quad$ **1c)** (Hiphil) to dislodge, let fall, drop
$\quad$ **1d)** (Hithpael) to be greatly shaken
