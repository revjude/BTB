...
$\quad$ **2a)** (Qal)
$\quad$ $\quad$ **2a1)** to be put down, become low
$\quad$ $\quad$ **2a2)** to be depressed, be downcast
$\quad$ $\quad$ **2a3)** to be afflicted
$\quad$ $\quad$ **2a4)** to stoop
$\quad$ **2b)** (Niphal)
$\quad$ $\quad$ **2b1)** to humble oneself, bow down
$\quad$ $\quad$ **2b2)** to be afflicted, be humbled
$\quad$ **2c)** (Piel)
$\quad$ $\quad$ **2c1)** to humble, mishandle, afflict
$\quad$ $\quad$ **2c2)** to humble, be humiliated
$\quad$ $\quad$ **2c3)** to afflict
$\quad$ $\quad$ **2d4)** to humble, weaken oneself
$\quad$ **2d)** (Pual)
$\quad$ $\quad$ **2d1)** to be afflicted
$\quad$ $\quad$ **2d2)** to be humbled
$\quad$ **2e)** (Hiphil) to afflict
$\quad$ **2f)** (Hithpael)
$\quad$ $\quad$ **2f1)** to humble oneself
$\quad$ $\quad$ **2f2)** to be afflicted
