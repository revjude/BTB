...
$\quad$ **1a)** that
$\quad$ $\quad$ **1a1)** yea, indeed
$\quad$ **1b)** when (of time)
$\quad$ $\quad$ **1b1)** when, if, though (with a concessive force)
$\quad$ **1c)** because, since (causal connection)
$\quad$ **1d)** but (after negative)
$\quad$ **1e)** that if, for if, indeed if, for though, but if
$\quad$ **1f)** but rather, but
$\quad$ **1g)** except that
$\quad$ **1h)** only, nevertheless
$\quad$ **1i)** surely
$\quad$ **1j)** that is
$\quad$ **1k)** but if
$\quad$ **1l)** for though
