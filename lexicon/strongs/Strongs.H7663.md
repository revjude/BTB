...
- ***to scrutinize***
-  by implication (of watching) ***to expect*** (with hope and patience)

**1)** to inspect, examine, wait, hope, wait upon
$\quad$ **1a)** (Qal) examined (participle)
$\quad$ **1b)** (Piel)
$\quad$ $\quad$ **1b1)** to wait (for), wait upon
$\quad$ $\quad$ **1b2)** to hope (for)
