...
$\quad$ **1a)** (Qal)
$\quad$ $\quad$ **1a1)** to grow up
$\quad$ $\quad$ **1a2)** to become great
$\quad$ $\quad$ **1a3)** to be magnified
$\quad$ **1b)** (Piel)
$\quad$ $\quad$ **1b1)** to cause to grow
$\quad$ $\quad$ **1b2)** to make great, powerful
$\quad$ $\quad$ **1b3)** to magnify
$\quad$ **1c)** (Pual) to be brought up
$\quad$ **1d)** (Hiphil)
$\quad$ $\quad$ **1d1)** to make great
$\quad$ $\quad$ **1d2)** to magnify
