...
- ***to smell bad***
-  figuratively, ***to be offensive*** morally

**1)** to have a bad smell, stink, smell bad
$\quad$ **1a)** (Qal) to stink, smell bad
$\quad$ **1b)** (Niphal)
$\quad$ $\quad$ **1b1)** to become odious
$\quad$ $\quad$ **1b2)** to make oneself odious
$\quad$ **1c)** (Hiphil)
$\quad$ $\quad$ **1c1)** to stink, emit a stinking odour
$\quad$ $\quad$ **1c2)** to cause to stink
$\quad$ $\quad$ **1c3)** of wickedness (fig.)
