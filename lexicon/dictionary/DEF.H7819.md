...
$\quad$ **1a)** (Qal)
$\quad$ $\quad$ **1a1)** to slaughter
$\quad$ $\quad$ $\quad$ **1a1a)** beast for food
$\quad$ $\quad$ $\quad$ **1a1b)** sacrifice
$\quad$ $\quad$ $\quad$ **1a1c)** person in human sacrifice
$\quad$ $\quad$ $\quad$ **1a1d)** beaten, hammered (of shekels)
$\quad$ **1b)** (Niphal) to be slaughtered, be slain (of food or sacrifice)
n f
**2)** (BDB) slaughtering
