<small>*Male • Returned from exile • Ancestor of a family that returned from Babylonian exile*</small>

Man living at the time of Exile and Return

<span class='tipnrhighlight'>Joab</span> was the ancestor of a family that returned to Judah from Babylonian exile \([[Ezra.2.6|Ezr.2.6]]; [[Neh.7.11|Neh.7.11]]\).
