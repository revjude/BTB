...
Josiah \(or Hen\) is mentioned as the son of Zephaniah, in whose house the silver and gold were to be stored until they were used to make a crown \([[Zech.6.10|Zechariah 6:10]], 14\). The crown was then to be placed on the head of Joshua, the high priest, as a symbol of the coming "Branch," a messianic figure who would build the temple and rule as both priest and king \(Zechariah 6:11-13\). 
