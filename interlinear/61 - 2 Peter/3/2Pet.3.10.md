...
[^2]: ==TR+Byz==: they will be dissolved | <span class="asgreek">λυθήσονται</span><small><sup>[[G3089]]</sup></small> | luthēsontai<small><sup>[[V-FPI-3P]]</sup></small>
[^3]: Extra Text:  <span class='asgreek'>**οὐχ**</span>  (<i>ouch</i>) 'not' is only in a few manuscripts (NA28)
[^4]: Variant:  <span class='asgreek'>**κατακαήσεται**</span>  (<i>katakaēsetai</i>) 'will be burned up' occurs in traditional manuscripts (TR+Byz) instead of <span class='asgreek'>**εὑρεθήσεται**</span>.  (<i>heurethēsetai</i>) 'will be exposed.' in older manuscripts (NA28+NA27+Tyn+SBL+WH+Treg)
[^5]: ==TR+Byz==: will be burned up | <span class="asgreek">κατακαήσεται</span><small><sup>[[G2618]]</sup></small> | katakaēsetai<small><sup>[[V-2FPI-3S]]</sup></small>
